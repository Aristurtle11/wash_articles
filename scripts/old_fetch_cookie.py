...
HEADERS_TEMPLATE_FILE = PROJECT_ROOT / "src/settings/default_headers.template.json"

COOKIE_JAR_FILE = PROJECT_ROOT / "data/state/cookies.txt"
HEADERS_FILE = PROJECT_ROOT / "src/settings/default_headers.json"
